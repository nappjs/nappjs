...
var NappJSModule = (function () {
    function NappJSModule(name, path) {
        this.name = name;
        this.path = path;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(typeof this.module.register === 'function')) return [3, 2];
                        return [4, this.module.register(app)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (typeof this.module.start === 'function') {
                    return [2, Promise.resolve(this.module.start(app))];
                }
                else if (typeof this.module === 'function') {
                    return [2, Promise.resolve(this.module(app))];
                }
                return [2];
            });
        });
