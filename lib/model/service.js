...
exports.createNappJSService = function (name, path) {
    ...
    return new module_1.NappJSServiceContainer(name, path, defaultModule, defaultModule.dependencies);
};
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                if (typeof this.module.load === 'function') {
                    return [2, (_a = this.module).load.apply(_a, [napp].concat(args))];
                }
                return [2];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                if (typeof this.module.start === 'function') {
                    return [2, (_a = this.module).start.apply(_a, [napp].concat(args))];
                }
                else if (typeof this.module === 'function') {
                    return [2, this.module.apply(this, [napp].concat(args))];
                }
                return [2];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                if (typeof this.module.stop === 'function') {
                    return [2, (_a = this.module).stop.apply(_a, [napp].concat(args))];
                }
                return [2];
            });
        });
