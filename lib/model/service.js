...
var NappJSObjectService = (function (_super) {
    ...
    NappJSObjectService.prototype.start = function (app) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (typeof this.module.start === 'function') {
                    return [2, this.module.start()];
                }
                else if (typeof this.module === 'function') {
                    return [2, this.module.apply(this, args)];
                }
                return [2];
            });
        });
    };
    NappJSObjectService.prototype.stop = function (app) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                if (typeof this.module.stop === 'function') {
                    return [2, (_a = this.module).stop.apply(_a, args)];
                }
                return [2];
            });
        });
