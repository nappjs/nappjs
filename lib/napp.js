...
var NappJS = (function () {
    ...
    NappJS.prototype.addMiddleware = function (name, path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.middlewares.push(model_1.createNappJSModule(name, path));
                return [2];
            });
        });
    };
    NappJS.prototype.addPlugin = function (name, path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.plugins.push(model_1.createNappJSModule(name, path));
                return [2];
            });
        });
    };
    NappJS.prototype.load = function () {
        return __awaiter(this, void 0, void 0, function () {
            var all, _i, all_1, v, _a, all_2, v, _b, all_3, v, _c, all_4, v;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 8:
                        ...
                        _d.label = 9;
                    case 9:
                        if (!(_b < all_3.length)) return [3, 12];
                        v = all_3[_b];
                    ...
                    case 12:
                        ...
                        _d.label = 13;
                    case 13:
                        if (!(_c < all_4.length)) return [3, 16];
                        v = all_4[_c];
                        return [4, v.postRegister(this)];
                    case 14:
                        _d.sent();
                        _d.label = 15;
                    case 15:
    ...
    NappJS.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            var all, _i, all_5, v, _a, all_6, v, _b, all_7, v;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _c.label = 1;
                    case 1:
                        if (!(_i < all_5.length)) return [3, 4];
                        v = all_5[_i];
                        return [4, v.preStart(this)];
                    case 2:
                        _c.sent();
                        _c.label = 3;
                    case 3:
                    ...
                    case 8:
                        ...
                        _c.label = 9;
                    case 9:
                        if (!(_b < all_7.length)) return [3, 12];
                        v = all_7[_b];
                        return [4, v.postStart(this)];
                    case 10:
                        _c.sent();
                        _c.label = 11;
                    case 11:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < all_8.length)) return [3, 4];
                        v = all_8[_i];
                        return [4, v.stop(this)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
