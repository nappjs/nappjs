...
var NappJS = (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        return [3, 1];
                    case 4:
                        _a = 0, _b = this.scriptWrappers;
                        _c.label = 5;
                    case 5:
                        if (!(_a < _b.length)) return [3, 8];
                        s = _b[_a];
                        return [4, s.register(this)];
                    case 6:
                        _c.sent();
                        _c.label = 7;
                    case 7:
    ...
    NappJS.prototype.stop = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                all = this.pluginWrappers.concat(this.middlewareWrappers);
                for (_i = 0, all_3 = all; _i < all_3.length; _i++) {
                    v = all_3[_i];
                }
                return [2];
            });
